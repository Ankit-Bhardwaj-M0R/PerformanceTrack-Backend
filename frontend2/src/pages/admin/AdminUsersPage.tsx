...
export default function AdminUsersPage(): JSX.Element {
  ...
  const loadUsers = async (): Promise<void> => {
    ...
    try {
      ...
      const list: UserDTO[] = (data as { content?: UserDTO[] }).content ?? (data as unknown as UserDTO[]) ?? []
      setUsers(list)
  ...
  const openEdit = (u: UserDTO): void => {
    ...
    setForm({
      ...
      managerId: u.manager?.userId != null ? String(u.manager.userId) : '',
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      if (editUser) {
        ...
        if (!updateData.password) delete (updateData as Partial<UserFormState>).password
