...
import type { GoalResponseDTO, CompletionFormState } from '../../types'
...
interface CompletionModalProps {
  ...
  setForm: (form: CompletionFormState) => void
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        {!managerFeedback && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-sm text-green-800">
            You are submitting <strong>{goal?.title}</strong> for completion review. Your manager
