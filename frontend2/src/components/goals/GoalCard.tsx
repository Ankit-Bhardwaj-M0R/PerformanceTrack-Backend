...
import type { GoalResponseDTO, AuthUser } from '../../types'
...
export default function GoalCard({
  ...
  return (
    <div
      className={`card border-l-4 ${priorityColors[goal.priority] || 'border-l-gray-300'} hover:shadow-md transition-shadow`}
    >
      {/* ── Header ── */}
        ...
        {isEmployee && isMyGoal && (
          <>
            ...
            {goal.status === 'PENDING_COMPLETION_APPROVAL' &&
              goal.completionApprovalStatus === 'ADDITIONAL_EVIDENCE_REQUIRED' && (
                <button
