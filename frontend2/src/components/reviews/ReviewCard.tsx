...
import type { PerformanceReviewResponseDTO, AuthUser } from '../../types'

/**
 * Single review row / card — used on both EmployeeReviewsPage and ManagerReviewsPage.
 */
interface ReviewCardProps {
  review: PerformanceReviewResponseDTO
  user: AuthUser | null
  isManager: boolean
  isEmployee: boolean
