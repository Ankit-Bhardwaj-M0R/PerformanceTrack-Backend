...
export default function ReportsPage() {
  ...
  const goalStatusData = goalAnalytics?.statusBreakdown
    ? Object.entries(goalAnalytics.statusBreakdown).map(([name, value]) => ({ name: name.replace(/_/g, ' '), value }))
    : dashboard
      ? [
  ...
  const deptData = deptPerformance?.departments
