 ...
 *
 * Props:
 *  isOpen, onClose, title ('Create New Goal' | 'Edit & Resubmit Goal')
 *  form, setForm           — controlled form state
 *  onSubmit                — form submit handler
 *  submitting              — boolean
 *  managerId               — show "assigned manager" hint when truthy
 *  managerFeedback         — array of feedback objects (shown in edit mode)
 */
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        {managerId && (
          <div className="bg-gray-50 rounded-lg p-3 text-sm text-gray-600">
            <span className="font-medium">Assigned Manager ID: </span>{managerId}
          </div>
        )}
