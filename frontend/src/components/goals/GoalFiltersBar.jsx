 ...
 * Props: searchTerm, statusFilter, priorityFilter, categoryFilter + their setters
 *        onClear  — called when the Clear button is clicked
 *        extra    — optional JSX appended at the right (e.g. "New Goal" button)
 */
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row gap-3 mb-3 flex-wrap">
        ...
        {hasFilters && (
          <button onClick={onClear} className="btn-secondary text-xs px-3">Clear</button>
        )}
