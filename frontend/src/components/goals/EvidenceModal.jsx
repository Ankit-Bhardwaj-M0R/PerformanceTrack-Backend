 ...
 * Props:
 *  isOpen, onClose
 *  goal                     — selected goal (for evidence link display)
 *  form, setForm            — { verificationStatus, notes }
 *  onSubmit, submitting
 */
export default function EvidenceModal({ isOpen, onClose, goal, form, setForm, onSubmit, submitting }) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Verify Evidence">
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select className="input-field" value={form.verificationStatus}
