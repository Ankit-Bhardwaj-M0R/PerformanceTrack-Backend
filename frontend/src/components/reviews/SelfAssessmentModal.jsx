 ...
 *
 * Props:
 *  isOpen, onClose, activeCycle
 *  form, setForm  — { selfAssessment, employeeSelfRating }
 *  onSubmit, submitting
 */
export default function SelfAssessmentModal({ isOpen, onClose, activeCycle, form, setForm, onSubmit, submitting }) {
  return (
