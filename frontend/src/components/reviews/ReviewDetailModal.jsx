        ...
        <div className="space-y-4">
          ...
          {review.selfAssessment && (
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <p className="text-xs text-blue-600 mt-2">Self Rating: {review.employeeSelfRating}/5</p>
            </div>
          )}
          ...
          {review.managerFeedback && (
            <div className="bg-green-50 rounded-lg p-4">
              ...
              <p className="text-xs text-green-600 mt-2">Manager Rating: {review.managerRating}/5</p>
              {review.ratingJustification && (
                <p className="text-xs text-gray-500 mt-1">Justification: {review.ratingJustification}</p>
              )}
              {review.compensationRecommendations && (
                <p className="text-xs text-gray-500 mt-1">Compensation: {review.compensationRecommendations}</p>
              )}
            </div>
          )}
